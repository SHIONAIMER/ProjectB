...
class_name CameraPostProcess

var rd: RenderingDevice
var shader: RID
var pipeline: RID
var shader_path: String = "res://Shaders/camera_post_process.glsl"
@export var vignette_power: float = 1.0
@export var vignette_radius: float = 1.0
...
func _render_callback(p_effect_callback_type: EffectCallbackType, p_render_data: RenderData) -> void:
	if rd and p_effect_callback_type == EFFECT_CALLBACK_TYPE_POST_TRANSPARENT and pipeline.is_valid():
		...
		if render_scene_buffers:
			...
			# 设置推断常量，由于PackedFloat32Array，需要填充0.0以匹配32字节
